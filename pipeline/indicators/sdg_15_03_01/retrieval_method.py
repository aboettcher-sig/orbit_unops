"""SDG 15.3.1 — Land Degradation (LULC sub-indicator).

NOTE: This is a scaffold / routing-proof stub.  Replace the body of
``run_15_03_01`` with real Earth Engine logic when the indicator is
...
def run_15_03_01(
    ...
    **kwargs: Any,
    ...
    requests with ``indicator_id == '15.3.1'`` to this function.
    ...
    return {
        ...
        "note": "Stub implementation for SDG 15.3.1 — no EE tasks were started.",
    }
