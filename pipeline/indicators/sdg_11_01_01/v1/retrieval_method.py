"""SDG 11.1.1 — Informal Settlements (Proxy).

NOTE: This is a scaffold / routing-proof stub.  Replace the body of
``run_11_01_01`` with real Earth Engine logic when the indicator is
...
def run_11_01_01(
    ...
    **kwargs: Any,
    ...
    requests with ``indicator_id == '11.1.1'`` to this function.
    ...
    return {
        ...
        "note": "Stub implementation for SDG 11.1.1 — no EE tasks were started.",
    }
