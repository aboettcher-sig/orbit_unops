"""SDG 15.4.2 — Mountain Green Cover & Degradation.

NOTE: This is a scaffold / routing-proof stub.  Replace the body of
``run_15_04_02`` with real Earth Engine logic when the indicator is
...
def run_15_04_02(
    ...
    **kwargs: Any,
    ...
    requests with ``indicator_id == '15.4.2'`` to this function.
    ...
    return {
        ...
        "note": "Stub implementation for SDG 15.4.2 — no EE tasks were started.",
    }
